...
def build():
    ...
    args = [
        ...
        "--hidden-import=src.aria2_engine", "--hidden-import=src.motrix",
        "--exclude-module=pywebview", "--exclude-module=pythonnet",
        "--exclude-module=clr_loader", "--exclude-module=webview",
